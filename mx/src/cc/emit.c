/* mx/emit.c - emit LLVM IR from an AST
...
void emit_function_decl(LLVMModuleRef mod, fn_expr_t *fn, LLVMLinkage linkage)
{
	...
	ident = fn->flags & FN_NOMANGLE ? fn->name : mx_mangle(fn);
